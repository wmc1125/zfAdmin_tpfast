...
-- ----------------------------
BEGIN;
INSERT INTO `zf_admin` VALUES (1, 3, 'admin', 'efd9d1b8bfb00e8e3647990f7d74d1d8', '', '', 0, 1, '23', 1, 0, '', 0, 2018, 0, '', 0, 'https://i.loli.net/2019/10/29/9OCU2VXHtAFhzoT.jpg');
...
CREATE TABLE `zf_admin_log` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台访问日志表';
...
CREATE TABLE `zf_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='系统变量表';
...
CREATE TABLE `zf_plugin` (
  ...
  `type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='插件列表';
...
INSERT INTO `zf_plugin` VALUES (2, 'zf_upgrade', '系统升级', '子枫', '2019-7-24', NULL, 1, NULL, 'v1.0.0', 'https://i.loli.net/2019/11/24/yvB3Kf4puY5WIU6.jpg', 'plugin');
COMMIT;
...
INSERT INTO `zf_post` VALUES (6, 2, '写经验交流材料的技巧全在这了！', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', 1, 1570606613, NULL, 0, NULL, '', '', '', 0.00, 0.00, '0', 10, '', '匿名', '', 0, 0, 0, NULL, 1, 0, 0, 0);
...
CREATE TABLE `zf_product_sku` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='产品sku';
...
CREATE TABLE `zf_product_sku_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='sku详细参数';
...
CREATE TABLE `zf_product_sku_info_parm` (
  ...
  `uid` varchar(11) CHARACTER SET utf8mb4 NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='sku相关联';
