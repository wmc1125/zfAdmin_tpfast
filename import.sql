...
-- Records of zf_admin
-- ----------------------------
INSERT INTO `zf_admin` VALUES ('1', '3', 'admin', 'e06e46026bc2c7bd5fe1dcb42b564ba7', '', '', '0', '1', '23', '1', '0', '', '0', '2018', '0', '', '0', 'https://i.loli.net/2019/10/29/9OCU2VXHtAFhzoT.jpg');
...
INSERT INTO `zf_admin_group` VALUES ('00000000009', '测试分组', '1', null, '0', '8,9,36,95,70,40,41,45,46,50,54,55,60,64,15,14,32,79,80,1,10,108');
...
CREATE TABLE `zf_admin_log` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='后台访问日志表';
...
INSERT INTO `zf_admin_role` VALUES ('84', '图片设置', 'admin/Config/img_config', '1', '1', '', '0', '144', 'admin', 'Config', 'img_config', '1');
...
INSERT INTO `zf_admin_role` VALUES ('133', '商品管理', 'admin/Products/', '1', '1', null, '0', '0', 'admin', 'Products', '', '1');
...
CREATE TABLE `zf_category_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='分类模型表';
...
CREATE TABLE `zf_category_model_parm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='模型参数列表';
...
CREATE TABLE `zf_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='系统变量表';

-- ----------------------------
-- Records of zf_config
-- ----------------------------
INSERT INTO `zf_config` VALUES ('1', 'zf_tpl_suffix', 'def', '1', null, 'system', '0');
INSERT INTO `zf_config` VALUES ('11', 'test1', 'aaa', '1', '测试11', 'user', '3');
...
CREATE TABLE `zf_plugin` (
  ...
  `type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='插件列表';

-- ----------------------------
-- Records of zf_plugin
-- ----------------------------
INSERT INTO `zf_plugin` VALUES ('3', 'demo', '测试', '子枫', '2019', null, '1', null, 'v1.0.0', 'https://i.loli.net/2019/11/24/yvB3Kf4puY5WIU6.jpg', null);
...
CREATE TABLE `zf_post` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='内容表';
...
INSERT INTO `zf_post` VALUES ('5', '2', '写经验交流材料的技巧全在这了！', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606608', null, '0', null, '', '', '', '0.00', '0.00', '0', '1', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
INSERT INTO `zf_post` VALUES ('6', '2', '写经验交流材料的技巧全在这了！', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606613', null, '0', null, '', '', '', '0.00', '0.00', '0', '4', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
INSERT INTO `zf_post` VALUES ('7', '2', '经验分享：我是如何做好每日计划的', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606623', null, '0', null, '', '', '', '0.00', '0.00', '0', '1', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
INSERT INTO `zf_post` VALUES ('8', '2', '经验分享：我是如何做好每日计划的', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606628', null, '0', null, '', '', '', '0.00', '0.00', '0', '3', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
INSERT INTO `zf_post` VALUES ('9', '2', '脾气不好的妈妈好好读读这篇文章，真的是细思极恐', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606640', null, '0', null, '', '', '', '0.00', '0.00', '0', '3', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
INSERT INTO `zf_post` VALUES ('10', '2', '养女儿，一定要让她漂亮！', '找老婆要找爱发脾气的女人。永远不会发脾气的女人就如同一杯白开水，解渴，却无味。而发脾气的女人正如烈酒般，刺激而令人无法忘怀。', 'http://v1.fast.zf.90ckm.com/template/index/a1/style//img/news_img1.jpg', '1', '1570606645', null, '2', '<p class=\"introTop\">TA家的珍珠是用黑糖熬制的，要熬整整四个小时才行，每熬一锅黑糖只能做出40杯奶茶，好味，是值得等待的。</p><div><img src=\"{$tpl_static}/img/news_big.jpg\" alt=\"新闻详情图\"/></div><p class=\"introBott\">北极光的制作，需要300g葡萄来完成，要选用最新鲜的葡萄，才能做出最灿烂的北极光。满满一瓶葡萄，看着就让人倍感满足。喝之前，要先摇9下，才能喝出最好的果味。晨曦的寓意是，清晨的阳光。要用到一整颗百香果的晨曦，喝起来酸酸甜甜，果味浓郁。晨曦喝起来果味极浓，不仅仅有百香果，还有芒果、橙汁...的味道，十分清新，彷佛夏日的一抹凉风！</p>', '', '', '', '0.00', '0.00', '0', '33', '', '匿名', '', '0', '0', '0', null, '1', '0', '0', '0');
...
CREATE TABLE `zf_product_sku` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='产品sku';
...
CREATE TABLE `zf_product_sku_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='sku详细参数';
...
CREATE TABLE `zf_product_sku_info_parm` (
  ...
  `uid` varchar(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COMMENT='sku相关联';
...
-- ----------------------------
INSERT INTO `zf_user_group` VALUES ('00000000001', '高级会员', '1', '2018', '0');
INSERT INTO `zf_user_group` VALUES ('00000000003', '普通会员', '1', '1538127552', '0');
