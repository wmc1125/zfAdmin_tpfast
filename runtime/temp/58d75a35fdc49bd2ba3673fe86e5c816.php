<?php /*a:3:{s:38:"./template/index/a1/cate/tpl_page.html";i:1569579034;s:38:"./template/index/a1/public/header.html";i:1569579509;s:38:"./template/index/a1/public/footer.html";i:1569549656;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-8">
            <p class="text-center " style="font-size: 25px;"><?php echo htmlentities($cate_res['name']); ?></p>
            <p class="text-center">
                <em class="em-margin">发布时间：<?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($cate_res['ctime'])? strtotime($cate_res['ctime']) : $cate_res['ctime'])); ?> </em>  
            </p>
            <!--内容--->
            <div style="word-break:break-all; font-size:16px;"><?php echo $cate_res['content']; ?></div>
            <!--内容 end--->
