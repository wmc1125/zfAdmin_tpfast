<?php /*a:2:{s:42:"./template/admin/category/article/add.html";i:1569479027;s:35:"./template/admin/public/editor.html";i:1568165645;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
              ...
              <div class="layui-col-sm9">
                <div class="layui-card">
                  ...
                  <div class="layui-card-body layui-row layui-col-space12">
                    <div class="layui-col-md12">
                      <textarea name="summary" placeholder="请输入" class="layui-textarea"></textarea>
                    </div>
                  </div>
...
<?php }else{ }?>
 ...
 layui.use(['form','upload','laydate'], function(){
    ...
    $(".tijiao").on("click",function(){
      ...
      $.ajax({
          type:'post',
          url:"<?php echo url('category/post_add'); ?>",
          data:data,
          dataType:'json',
