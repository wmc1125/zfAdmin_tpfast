<?php /*a:3:{s:36:"./template/index/a1/index/index.html";i:1569579896;s:38:"./template/index/a1/public/header.html";i:1569579509;s:38:"./template/index/a1/public/footer.html";i:1569549656;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="swiper-container">
    <div class="swiper-wrapper">
        <?php foreach($banner as $k=>$vo){ ?>
        <div class="swiper-slide">
            <!-- <img class="img-responsive margin-width" src="<?php echo htmlentities($vo['pic']); ?>" alt="<?php echo htmlentities($vo['name']); ?>" title="<?php echo htmlentities($vo['name']); ?>"/> -->
        </div>
        <?php } ?>
    </div>
    <!-- 如果需要分页器 -->
    ...
    <div class="row" style="margin-top:2px;">
        <div class="col-sm-6 col-md-8"><!--文章推荐-->
            <div class="panel panel-default">
                <div class="panel-heading font-size" >最新<span style="color: #ff0099;">文章</span></div>
                <div class="panel-body ul-list">
                    <ul class="media-list">
                        <?php foreach($post_new as $k=>$vo){ ?>
                        <li class="media">
