<?php /*a:1:{s:35:"./template/admin/index/welcome.html";i:1569478548;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="layui-fluid">
    <div class="layui-row layui-col-space15">
                ...
                <div class="layui-carousel layadmin-carousel layadmin-shortcut">
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      ...
                      <li class="layui-col-xs3">
                        <a href="home/homepage2.html">
                          <i class="layui-icon layui-icon-chart"></i>
                          <cite>主页二</cite>
                        </a>
                      </li>
                      <li class="layui-col-xs3">
                        <a href="component/layer/list.html">
                      ...
                      <li class="layui-col-xs3">
                        <a href="component/progress/index.html">
                          <i class="layui-icon layui-icon-find-fill"></i>
                          <cite>进度条</cite>
                        </a>
                      </li>
                      <li class="layui-col-xs3">
                        <a href="app/workorder/list.html">
                          <i class="layui-icon layui-icon-survey"></i>
                          <cite>工单</cite>
                        </a>
                      </li>
                      <li class="layui-col-xs3">
                        <a href="user/user/list.html">
                  ...
                  <div carousel-item>
                    <ul class="layui-row layui-col-space10">
                      <li class="layui-col-xs6">
                        <a href="app/content/comment.html" class="layadmin-backlog-body">
                          <h3>待审评论</h3>
                          <p><cite>66</cite></p>
                        </a>
                      </li>
                      <li class="layui-col-xs6">
                        <a href="app/forum/list.html" class="layadmin-backlog-body">
                          <h3>待审帖子</h3>
                          <p><cite>12</cite></p>
                        </a>
                      </li>
                      <li class="layui-col-xs6">
                        <a href="template/goodslist.html" class="layadmin-backlog-body">
                          <h3>待审商品</h3>
                          <p><cite>99</cite></p>
                        </a>
                      </li>
      ...
      <div class="layui-col-md4">
            ...
            <table class="layui-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="padding-bottom: 0;">
                    <div class="layui-btn-container">
                      <a href="http://demo.zf.90ckm.com" target="_blank" class="layui-btn layui-btn-danger">子枫后台系统</a>
                    </div>
                  </td>
                </tr>
              </tbody>
        ...
        <div class="layui-card">
          <div class="layui-card-header">系统</div>
  ...
  <script src="/public/static/style/layui/layui.js?t=1"></script>  
  <script>
 layui.use(['console'],function(){
    ...
    layer.open({
      ...
      shade: false,
      title: false, //不显示标题
      content: $('.aaaaa'), //捕获的元素，注意：最好该指定的元素要存放在body最外层，否则可能被其它的相对元素所影响
      cancel: function(){
