<?php /*a:1:{s:44:"./template/admin/category/article/index.html";i:1569477750;}*/ ?>
          ...
          <div class="layui-form-item">
            ...
            <!-- <form onclick="return false;" class="create_info"> -->
              <div class="layui-inline">
                  ...
                  <!-- <button class="layui-btn layui-btn-sm" onclick='zfAdminShow("内容采集","<?php echo url('category/bqb_querylist'); ?>")'>采集</button>  -->
            ...
            <tbody>
              <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                  ...
                  <td> <a class="layui-btn btn_del layui-btn-danger layui-btn-sm" rel="<?php echo htmlentities($vo['id']); ?>" href="#">删除</a> <button class="layui-btn layui-btn-sm" onclick='zfAdminShow("编辑","<?php echo url('category/post_edit',['id' => $vo['id'],'cid' => $vo['cid'],'mid' => $mid] ); ?>")'>编辑</button> </td>
                </tr>
